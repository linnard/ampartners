...
return [
    ...
    */
    'attributes' => [
        ...
        'user.patronymic'       => 'По батькові',
        'company.name'          => 'Назва компанії',
        'company.phone'         => 'Контактний телефон',
        'company.viber'         => 'Viber',
        'company.site'          => 'Сайт',
        'company.license_url'   => 'Посилання на ліцензію',
        'company.facebook_url'  => 'Сторінка компанії на FaceBook',
        'company.instagram_url' => 'Сторінка компанії в Instagram',
