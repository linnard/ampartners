            ...
            <div class="JobList Jobs_list">
                ...
                <div class="JobList_items">
                    <div v-for="vacancy in vacancies" class="Job JobList_item">
                        ...
                        <div class="Job_text">
                            <div class="Message Job_message" v-if="vacancy.description">
                                {{vacancy.description}}
                            </div>
                            ...
                            <div class="JobReservation Job_reservation">
                                <a href="javascript:;"
                                   class="BtnGreen BtnGreen-fullJob BtnGreen-fullJobDescription JobReservation_btn">
                            ...
                            Безкоштовно</span><span class="BtnGreen_text">забронювати вакансію</span>
                                ...
                                <div class="JobReservation_detailed JobReservation_detailed-noBorder JobReservation_detailed-textCenter">
                                    ...
                                    <div class="JobReservation_text JobReservation_text-large">
                                        <strong>Для безкоштовного бронювання вакансії</strong> зв'яжіться з нами зручним
                                        для вас способом:
                                    </div>
                                    <a href="javascript:;"
                                       class="BtnGreen BtnGreen-callOrder JobReservation_callOrderBtn JobReservation_callOrderBtn-largeIndent">
                                    ...
                                    <div class="Messengers Messengers-jobReservation JobReservation_messengers">
                                        <ul class="Messengers_list">
                                            <li class="Messengers_item">
                                                <a href="viber://chat?number=+380974303916"
                                                   class="MessengerBtn MessengerBtn-small MessengerBtn-vbOutline hidden-xxs">
                                            <span class="MessengerBtn_icon">
                                                <svg class="SvgIco" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 28.99 30.01"><g data-name="Слой 2"><path
                                                        class="SvgIco_path"
                                                        ...
                                                        fill="#fff" data-name="Слой 1"></path></g></svg>
                                            </span>
                                                ...
                                                <a href="viber://add?number=380974303916"
                                                   class="MessengerBtn MessengerBtn-small MessengerBtn-vbOutline hidden-xxsPlus">
                                            <span class="MessengerBtn_icon">
                                                <svg class="SvgIco" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 28.99 30.01"><g data-name="Слой 2"><path
                                                        class="SvgIco_path"
                                            ...
                                            <li class="Messengers_item">
                                                <a href="tg://resolve?domain=ampartners"
                                                   class="MessengerBtn MessengerBtn-telegram MessengerBtn-small MessengerBtn-tgOutline">
                                            <span class="MessengerBtn_icon">
                                                <svg class="SvgIco" xmlns="http://www.w3.org/2000/svg"
                                                     viewBox="0 0 29.99 25.03"><g data-name="Слой 2"><path
                                                        class="SvgIco_path"
                                                        d="M28.07.1L.64 10.69a1 1 0 0 0 .08 1.87l7 2 2.6 8.18a1.2 1.2 0 0 0 2 .47l3.6-3.64L23 24.75a1.48 1.48 0 0 0 2.32-.88L30 1.69A1.4 1.4 0 0 0 28.07.1zM24.63 5L11.89 16.18a.68.68 0 0 0-.23.43l-.49 4.32a.13.13 0 0 1-.26 0l-2-6.44a.68.68 0 0 1 .3-.78l15-9.25a.33.33 0 0 1 .42.54z"
                                                        fill="#fff" data-name="Слой 1"></path></g></svg>
                                            </span>
                                                    <span class="MessengerBtn_textWrap">
                                                <span class="MessengerBtn_text MessengerBtn_text-small">Написати у</span>
